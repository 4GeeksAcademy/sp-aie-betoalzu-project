    ...
    <main className="mx-auto w-full max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
      <section className="mb-8 rounded-3xl border border-slate-200 bg-white/95 p-6 shadow-xl shadow-slate-200/60 sm:p-8">
        ...
        <p className="mt-2 max-w-3xl text-sm text-slate-600 sm:text-base">
          Registra, clasifica y da seguimiento a incidencias técnicas, operativas y de clientes.
          Incluye datos históricos del helpdesk de soporte al cliente.
        </p>
      </section>

      <IncidentsManagerClient />
    </main>
  );
}