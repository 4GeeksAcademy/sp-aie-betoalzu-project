...
# Tarea
- realiza en `/scripts` un seed.py donde se carguen todos los datos proporcionados en este .md en TinyDB 
- el script debe ejecutarse usando el comando `uv run seed`
- verifica si la base de datos ya tiene datos, que no haya duplicados
confirma en consola cuando el proceso haya terminado